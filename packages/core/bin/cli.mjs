...
try {
  switch (cmd) {
    ...
    default:
      out('Usage: ocmw <init|ingest <path>|remember <text>|query <text>|recall <id>|brief|lint|project|promote <id> <tier>|bridge> [--type --title --tier --tiers --scope --scopes --limit --graph --curated]');
  }
